...
export default {
  ...
  methods: {
    ...
    fetchThumb(projectThumb) {
      return `http://127.0.0.1:8000/storage/${projectThumb}`;
    },
  },
  beforeMount() {
...
<template>
  <div class="content">
    <div class="container p-5">
      <div class="row g-3" v-if="projects.length > 0">
        <div
          class="col-12 col-sm-6 col-md-4 col-lg-3"
          v-for="project in projects"
        >
          {{ project.slug }}
          <a class="text-decoration-none text-white h-100 w-100">
            <div
              class="card bg-transparent overflow-hidden h-100 position-relative"
            >
              <div class="card-content-box h-100">
                <img
                  :src="fetchThumb(project.thumb)"
